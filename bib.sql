...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 06 déc. 2025 à 19:07
...
CREATE TABLE `emprunt` (
  ...
  `Prolongation_Demande` tinyint(1) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `emprunt` (`ID_Emprunt`, `ID_Etudiant`, `ID_Exemplaire`, `Date_Emprunt`, `Date_Retour`, `Etat_Retour`, `Date_Retour_Prevu`, `Prolongation_Demande`) VALUES
(1, 1, 1, '2025-12-06 00:23:07', NULL, 'non rendu', '2026-01-05 00:23:07', 0),
(2, 1, 4, '2025-12-06 01:07:33', NULL, 'non rendu', '2025-12-21 01:07:33', 1);
...
INSERT INTO `evaluation` (`ID_Evaluation`, `ID_Etudiant`, `ISBN`, `Note`, `Commentaire`, `Date_Evaluation`) VALUES
(1, 1, 'ISBN0003', 4, 'l3alamiya', '2025-12-06 09:33:53');
...
(8, 'ISBN0003', 'bon etat'),
(9, 'ISBN0004', 'bon etat'),
(10, 'ISBN0004', 'mauvais etat'),
(11, 'ISBN0005', 'bon etat'),
(12, 'ISBN0005', 'bon etat'),
(13, 'ISBN0009', 'bon etat'),
(14, 'ISBN0010', 'bon etat'),
(15, 'ISBN0011', 'bon etat'),
(16, 'ISBN0012', 'bon etat');
...
INSERT INTO `favoris` (`ID_Etudiant`, `ISBN`, `Date_Ajout`) VALUES
(1, 'ISBN0002', '2025-12-06 09:32:00'),
(1, 'ISBN0003', '2025-12-06 09:33:21');
...
INSERT INTO `message` (`ID_Message`, `ID_Etudiant`, `Sens`, `Contenu`, `Date_Envoi`, `Lu`) VALUES
(1, 1, 'etudiant-vers-admin', 'Sujet: cvv\n\nfdgfd', '2025-12-06 01:00:39', 1),
(2, 1, 'etudiant-vers-admin', 'Sujet: dsfds\n\ncvcsfd', '2025-12-06 01:10:07', 1);
...
INSERT INTO `reservation` (`ID_Reservation`, `ID_Etudiant`, `Statut`, `ISBN`, `Date_Reservation`) VALUES
(1, 1, 'acceptee', 'ISBN0001', '2025-12-06 00:15:11'),
(2, 1, 'acceptee', 'ISBN0002', '2025-12-06 00:21:27'),
(7, 1, 'en attente', 'ISBN0008', '2025-12-06 01:08:53'),
(8, 1, 'en attente', 'ISBN0055', '2025-12-06 12:07:31'),
(9, 1, 'en attente', 'ISBN0030', '2025-12-06 12:07:34');
...
--
-- Structure de la table `suggestion_livre`
--

CREATE TABLE `suggestion_livre` (
...
--
ALTER TABLE `favoris`
  ADD PRIMARY KEY (`ID_Etudiant`,`ISBN`),
  ADD KEY `ISBN` (`ISBN`);
...
--
-- Index pour la table `suggestion_livre`
--
ALTER TABLE `suggestion_livre`
...
--
ALTER TABLE `exemplaire`
  MODIFY `ID_Exemplaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- AUTO_INCREMENT pour la table `suggestion_livre`
--
ALTER TABLE `suggestion_livre`
...
--
ALTER TABLE `favoris`
  ADD CONSTRAINT `favoris_ibfk_1` FOREIGN KEY (`ID_Etudiant`) REFERENCES `student` (`ID_Etudiant`) ON DELETE CASCADE,
  ADD CONSTRAINT `favoris_ibfk_2` FOREIGN KEY (`ISBN`) REFERENCES `livre` (`ISBN`) ON DELETE CASCADE;
...
--
-- Contraintes pour la table `suggestion_livre`
--
ALTER TABLE `suggestion_livre`
  ADD CONSTRAINT `suggestion_livre_ibfk_1` FOREIGN KEY (`ID_Etudiant`) REFERENCES `student` (`ID_Etudiant`) ON DELETE CASCADE;
COMMIT;
